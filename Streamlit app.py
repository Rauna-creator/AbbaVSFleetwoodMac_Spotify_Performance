...
try:
    ...
    if page == "Overview":
        ...
        st.markdown("---")
        st.subheader("Feature Comparison Visualization")
        
        # Feature selector
        col1, col2 = st.columns([1, 3])
        with col1:
            selected_feature_hd = st.selectbox(
                "Select feature to visualize",
                features,
                key="hits_deep_cuts_feature"
            )
        
        # Show selected feature boxplot
        ...
        st.write(f"**{selected_feature_hd} Statistics:**")
        col1, col2, col3, col4 = st.columns(4)
        ...
        col3.metric("Difference", f"{comparison.loc[selected_feature_hd, 'Difference']:+.3f}")
        col4.metric("Significance", comparison.loc[selected_feature_hd, 'Significant'])
